...
// MISSION! Load Template by Custom Post Type
	 ...
	 echo '<div class="grid-container"><div class="grid-x grid-margin-x"><div class="cell small-12">';
				...
				echo '<div class="cell small-12 medium-3"><div class="responsive-embed widescreen"><iframe width="560" height="315" src="" data-src="//www.youtube.com/embed/3qsvFrZpsHQ?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe></div></div>';
